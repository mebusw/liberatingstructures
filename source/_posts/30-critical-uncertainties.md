...
- 每个小组以[W³反思法](/9-what-so-what-now-what-w)进行汇报，10分钟
- 四个小组分享汇报，全组对自己的“现在又怎样”进行第一步决策。10分钟
### 小贴士和小坑
- 在头脑风暴中讨论不确定因素时，回忆一下出错的预测和让大家措手不及的事件
- 挑战一厢情愿的想法
- 每一步都用[1-2-4-All](/1-1-2-4-all)，周期很短
- 为每一个象限命名（歌名和书名都很好）
...
- 将[畅谈咖啡馆](/17-conversation-cafe)、[从目的到实践（P2P）](/33-purpose-to-practice-p2p)、[我需要你](/24-what-i-need-from-you-winfy)、[开放空间技术](/25-open-space-technology)、[悖论问题](/4-wicked-questions)和[最小规格](/14-min-specs)串在一起
